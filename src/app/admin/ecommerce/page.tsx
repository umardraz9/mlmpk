  ...
  const fetchData = async () => {
    ...
    try {
      const [productsRes, ordersRes, analyticsRes] = await Promise.all([
        ...
        fetch('/api/admin/analytics/ecommerce')
      ]);
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage products, orders, payments, and analytics</p>
        </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">PKR {analytics.totalRevenue.toLocaleString()}</div>
                    <p className="text-xs text-muted-foreground">
                      ...
                      <div key={product.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">PKR {product.price}</p>
                          </div>
                        </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredProducts.map((product) => (
                      <tr key={product.id} className="hover:bg-gray-50">
                          ...
                          <div className="flex items-center">
                            ...
                            <div>
                              <div className="text-sm font-medium text-gray-900">
                                {product.name}
                                {product.trending && (
                                  <TrendingUp className="inline h-4 w-4 text-green-500 ml-2" />
                                )}
                              </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className={`text-sm ${product.quantity < 10 ? 'text-red-600' : 'text-gray-900'}`}>
                            {product.quantity}
                            {product.quantity < 10 && (
        ...
        <TabsContent value="payments" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track COD and online payments</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sales, customers, and product performance</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-center text-gray-500 py-8">
