...
export async function GET() {
  try {
    ...
    const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNmbWVlbWh0anh3c2V1dnpjanlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjk1MjU1NzYsImV4cCI6MjA0NTEwMTU3Nn0.laKgTLlV8ucIUAu1';
