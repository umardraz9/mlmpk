# Fix with correct Supabase Pooler format
Write-Host "Trying correct pooler format..." -ForegroundColor Green

$envContent = 'DATABASE_URL="postgresql://postgres.sfmeemhtjxwseuvzcjyd:LKZC1GSTR3U7TnSz@aws-0-us-east-1.pooler.supabase.com:5432/postgres"
...
Write-Host "Updated! Please restart: npm run dev" -ForegroundColor Yellow
